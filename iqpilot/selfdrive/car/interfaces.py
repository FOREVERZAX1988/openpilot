...
from openpilot.iqpilot.selfdrive.controls.lib.nnlc.helpers import get_nn_model_path
from openpilot.iqpilot.selfdrive.controls.lib.speed_limit.helpers import set_speed_limit_assist_availability
...
def _initialize_neural_network_lateral_control(CP: structs.CarParams, CP_IQ: structs.IQCarParams,
  ...
  CP_IQ.neuralNetworkLateralControl.model.path = nnlc_model_path
  CP_IQ.neuralNetworkLateralControl.model.name = nnlc_model_name
  CP_IQ.neuralNetworkLateralControl.fuzzyFingerprint = not exact_match
...
def _cleanup_unsupported_params(CP: structs.CarParams, CP_IQ: structs.IQCarParams, params: Params = None) -> None:
  ...
  if not CP.openpilotLongitudinalControl and CP_IQ.pcmCruiseSpeed:
    ...
    params.remove("IQDynamicMode")
    params.remove("CustomAccIncrementsEnabled")
    params.remove("SmartCruiseControlVision")
    params.remove("SmartCruiseControlMap")

  set_speed_limit_assist_availability(CP, CP_IQ, params)
...
def setup_interfaces(CI: CarInterfaceBase, params: Params = None) -> None:
  ...
  nnlc_enabled = _initialize_neural_network_lateral_control(CP, CP_IQ, params)
  _initialize_torque_lateral_control(CI, CP, enforce_torque, nnlc_enabled)
  _cleanup_unsupported_params(CP, CP_IQ)
