...
struct CarState {
  ...
  cruiseFaultLateralMode @61 :Bool;  # allows lateral availability when longitudinal cruise is faulted
  lateralAvailable @62 :Bool;  # whether lateral can be engaged this frame
  ...
  fuelTankLevelL @63 :Float32; # raw fuel tank liters
  charging @43 :Bool;
...
struct CarControl {
  ...
  struct HUDControl {
    ...
    leadDistance @11: Float32;  # lead distance in meters for HUD-capable ports
