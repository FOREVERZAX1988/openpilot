...
from sunnypilot.konn3kt.api import Konn3ktApi
from sunnypilot.konn3kt.backups.utils import decrypt_compressed_data, encrypt_compress_data, SnakeCaseEncoder
from sunnypilot.konn3kt.common.params import param_to_bytes, param_from_base64
  ...
  async def create_backup(self) -> bool:
    ...
    try:
      ...
      backup_info.backupMetadata = [
        custom.BackupManagerSP.MetadataEntry(key="creator", value="BackupManagerK3"),
