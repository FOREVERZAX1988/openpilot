...
class SteeringLayout(Widget):
  ...
  def _initialize_items(self):
    self._mads_base_desc = tr("Enable Always on Lateral (AOL). " +
                              "Disable toggle to revert back to stock sunnypilot engagement/disengagement.")
    self._mads_limited_desc = tr("This platform supports limited AOL settings.")
    self._mads_full_desc = tr("This platform supports all AOL settings.")
