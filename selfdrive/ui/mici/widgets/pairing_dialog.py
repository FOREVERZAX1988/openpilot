...
from openpilot.system.athena.registration import get_or_create_dongle_id, ensure_dev_pairing_identity
...
class PairingDialog(NavWidget):
  ...
  def __init__(self):
    ...
    self._pair_label = MiciLabel("pair with Konn3kt", 48, font_weight=FontWeight.BOLD,
