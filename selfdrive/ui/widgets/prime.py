...
class PrimeWidget(Widget):
  ...
  def _render_for_unpaired_users(self, rect: rl.Rectangle):
    ...
    wrapped_text = "\n".join(wrap_text(font, tr("Pair your device with Konn3kt at konn3kt.com"), 56, int(w)))
    ...
    gui_label(rl.Rectangle(x, features_y, w, 50), tr("FEATURES:"), 41, font_weight=FontWeight.BOLD)
