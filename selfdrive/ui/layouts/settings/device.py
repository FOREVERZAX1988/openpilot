...
class DeviceLayout(Widget):
  ...
  def _initialize_items(self):
    ...
    self._force_offroad_btn = button_item(
      lambda: tr("Force Offroad"),
      lambda: tr("ENABLE") if not self._params.get_bool("OffroadMode") else tr("DISABLE"),
      lambda: tr("Temporarily force IQ.Pilot to stay offroad until toggled off."),
      callback=self._toggle_force_offroad,
    )
  ...
  def _toggle_force_offroad(self):
    force_offroad = not self._params.get_bool("OffroadMode")
    self._params.put_bool("OffroadMode", force_offroad)
