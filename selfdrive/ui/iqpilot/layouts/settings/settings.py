...
class NavButton(Widget):
  ...
  def _render(self, rect):
    ...
    # translate name during rendering
...
class IQSettingsLayout(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      OP.PanelType.DISPLAY: PanelInfo(tr_noop("Display"), DisplayLayout(), icon="../../iqpilot/selfdrive/assets/offroad/icon_display.png"),
      OP.PanelType.OSM: PanelInfo(tr_noop("OSM"), OSMLayout(), icon="../../iqpilot/selfdrive/assets/offroad/icon_map.png"),
