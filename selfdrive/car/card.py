...
from openpilot.selfdrive.car.helpers import convert_iq_car_control, convert_to_capnp

from openpilot.iqpilot.aol.helpers import set_alternative_experience, set_car_specific_params
...
class Car:
  ...
  def __init__(self, CI=None, RI=None) -> None:
    ...
    # AOL
    set_alternative_experience(self.CP, self.CP_IQ, self.params)
    set_car_specific_params(self.CP, self.CP_IQ, self.params)
  ...
  def controls_update(self, CS: car.CarState, CC: car.CarControl, CC_IQ: custom.IQCarControl):
    ...
    if self.sm.all_alive(['carControl']):
      ...
      self.last_actuators_output, can_sends = self.CI.apply(CC, convert_iq_car_control(CC_IQ), now_nanos)
