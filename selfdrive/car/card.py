...
class Car:
  ...
  def __init__(self, CI=None, RI=None) -> None:
    ...
    self.sm = messaging.SubMaster(['pandaStates', 'carControl', 'onroadEvents', 'testJoystick'] + ['carControlSP', 'longitudinalPlanSP'])
  ...
  def inject_joystick_buttons(self, CS: car.CarState) -> None:
    ...
    if engage:
      self.params.put("JoystickMadsRequest", "enable")
    if disengage:
      self.params.put("JoystickMadsRequest", "disable")
