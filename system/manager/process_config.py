...
from sunnypilot.konn3kt.utils import hephaestus_ready
...
procs += [
  ...
  PythonProcess("backup_manager_k3", "sunnypilot.konn3kt.backups.manager", and_(only_offroad, hephaestus_ready_shim)),
